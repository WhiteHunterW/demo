...
import com.example.springframe.context.support.ClassPathXmlApplicationContext;
...
public class ResourceLoaderTest {
    ...
    public void testAware() {
        ...
        String result = userService.getUserInfo();
        System.out.println(result);
        System.out.println("applicationContext is "+userService.getApplicationContextAware());
        System.out.println("beanFactory is " + userService.getBeanFactory());
